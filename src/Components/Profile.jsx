...
export default function Profile() {
  ...
  return (
    <div className="flex m-auto md:mx-30 lg:mx-70 py-10 flex-col gap-8 mx-1">
      <div
      ...
      <div className=" rounded-2xl  shadow-[0_8px_10px_rgba(0,0,0,0.12)] ">
        <div className="bg-[#e1e1fc] flex items-center gap-6 py-10 rounded-t-2xl px-8">
          ...
          <div className="flex flex-col items-start ">
            <h3 className="text-black font-[700] text-2xl">
              {user?.fullName || user?.firstName || "Name not found"}
            </h3>
            <div className="flex flex-col items-start gap-2">
              <h5 className="text-[#6f7b88] text-[14px]">
                {user?.primaryEmailAddress?.emailAddress || "Email not found"}
              </h5>
        ...
        <div className=" py-6 px-8 bg-white rounded-b-2xl">
          ...
          <div className="flex flex-col my-5 gap-4">
            ...
            <div className="flex items-center px-3  py-3 rounded-xl  w-full gap-4 bg-[#f3f3f487]">
              ...
              <span className="flex flex-col items-start">
                ...
                <h2 className="text-black font-bold break-all">
                  {user.id}
                </h2>
              </span>
            </div>
          ...
          <button
            onClick={() => signOut()}
            className="cursor-pointer flex items-center gap-2 px-4 rounded-lg py-1.5 mt-5 bg-[#fdecec] text-[#ef4374] font-bold"
          >
            {" "}
